    ...
    return (
        <section className="text-white font-roboto">
            ...
            <div className="hidden xl:hidden lg:flex justify-center">
                <div className="flex flex-col gap-12 bg-primary-800 w-[980px] p-10">
            ...
            {/* 640px and up to 1023px */}
            <div className="hidden lg:hidden sm:flex justify-center">
                <div className="flex flex-col gap-12 md:gap-20 bg-primary-800 py-10 px-4 md:px-10">
            ...
            <div className="sm:hidden flex justify-center">
                <div className="flex flex-col gap-12 bg-primary-800 py-10 px-4">
