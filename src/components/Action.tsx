    ...
    return (
        <section className="flex justify-center py-20">
            <div className="flex flex-col gap-8 bg-primary-500 w-[350px] sm:w-[550px] lg:w-[840px] p-6 sm:p-10 rounded-2xl">
                <h2 className="font-montserrat text-white text-[22px] font-bold sm:text-2xl">Take the Next Step Today</h2>
                <p className="text-4 font-karla text-white">Join us in connecting skilled Ukrainians with rewarding opportunities in the UK job market.</p>
